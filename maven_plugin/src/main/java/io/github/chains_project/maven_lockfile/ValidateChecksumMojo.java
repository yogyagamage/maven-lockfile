    ...
    public void execute() throws MojoExecutionException {
        ...
        try {
            ...
            if (!lockFileFromFile.equals(lockFileFromProject)) {
                ...
                String sa = "Lock file validation failed. There are packages which are modified." + "\n"
                        + "Modified dependencies in project: " + "\n"
                        + JsonUtils.toJson(diff.getDependenciesWithInvalidChecksums())
                        + "Modified plugins in project: " + "\n"
                        + JsonUtils.toJson(diff.getPluginsWithInvalidChecksums())
                        + "\n";
                String sb = "Lock file validation failed. Differences:" + "\n"
                        ...
                        + "\n";
                throw new MojoExecutionException("Failed verifying lock file" + sa);
            }
        } catch (IOException e) {
